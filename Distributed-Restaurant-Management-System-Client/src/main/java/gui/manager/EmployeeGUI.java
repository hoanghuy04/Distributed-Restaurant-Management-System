...
public class EmployeeGUI extends javax.swing.JPanel {
     ...
     */
    public EmployeeGUI() throws Exception {
        empBUS = FormLoad.employeeBUS;
        roleBUS = FormLoad.roleBUS;
    ...
    private void customTable() throws Exception {
        String[] headers = {
                "Mã nhân viên", "Tên nhân viên", "Ngày tạo", "Điện thoại",
                "Đường", "Phường", "Quận", "Huyện/ TP",
                "Email", "Mật khẩu", "Vai trò", "Hoạt động"
        };

        List<Integer> tableWidth = Arrays.asList(
                100, 150, 100, 100,  // Corresponding to first 4 headers
                120, 120, 80, 100,   // Address details
                150, 120, 100, 80    // Email to "Hoạt động"
        );
    ...
    private boolean validatePhoneAndEmail(EmployeeEntity employeeEntity) throws RemoteException {
        List<EmployeeEntity> existingEmployees = empBUS.getAllEntities();
        for (EmployeeEntity existingEmployee : existingEmployees) {
            if (existingEmployee.getPhoneNumber().equals(employeeEntity.getPhoneNumber())) {
            ...
            if (existingEmployee.getEmail().equals(employeeEntity.getEmail())) {
                Notifications.getInstance().show(
                        Notifications.Type.WARNING,
                        Notifications.Location.TOP_RIGHT,
                        10000,
    ...
    private void loadData() throws Exception {
        ...
        for (EmployeeEntity emp : emps) {
            tableModel.addRow(new Object[]{emp.getEmployeeId(), emp.getFullname(), emp.getCreatedDate(), emp.getPhoneNumber(),
                    emp.getAddress().getStreet(), emp.getAddress().getWard(), emp.getAddress().getDistrict(), emp.getAddress().getCity(), emp.getEmail(), emp.getPassword(),
    ...
    private void initComponents() throws Exception {
        ...
        lblStreet.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        lblStreet.setText("Đường");
        lblStreet.setPreferredSize(new java.awt.Dimension(100, 20));

        lblWard.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        lblWard.setText("Phường");
        lblWard.setPreferredSize(new java.awt.Dimension(100, 20));

        lblDistrict.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        lblDistrict.setText("Quận");
        lblDistrict.setPreferredSize(new java.awt.Dimension(100, 20));

        lblCity.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        lblCity.setText("Huyện / TP");
        lblCity.setPreferredSize(new java.awt.Dimension(100, 20));
                ...
                panelDetailInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelDetailInfoLayout.createSequentialGroup()
                                ...
                                .addGroup(panelDetailInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(panelDetailInfoLayout.createSequentialGroup()
                                                .addComponent(lblStreet, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(txtStreet, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(panelDetailInfoLayout.createSequentialGroup()
                                                .addComponent(lblWard, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(txtWard, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(panelDetailInfoLayout.createSequentialGroup()
                                                .addComponent(lblDistrict, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        panelDetailInfoLayout.setVerticalGroup(
                panelDetailInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(panelDetailInfoLayout.createSequentialGroup()
                                ...
                                .addGroup(panelDetailInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addGroup(panelDetailInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addGroup(panelDetailInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                        .addComponent(lblStreet, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                                ...
                                .addGroup(panelDetailInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(panelDetailInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                .addComponent(lblWard, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addComponent(txtWard, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(panelDetailInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                ...
                                .addGroup(panelDetailInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(panelDetailInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                .addComponent(lblDistrict, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                panelTableLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(panelTableLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(panelTableLayout.createSequentialGroup()
                                        .addContainerGap()
                                        .addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 1875, Short.MAX_VALUE)
                                        .addContainerGap()))
        );
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) throws Exception {//GEN-FIRST:event_btnAddActionPerformed
        ...
        Address address = new Address(txtStreet.getText(), txtWard.getText(), txtDistrict.getText(), txtCity.getText());
        ...
        if (validatePhoneAndEmail(empNew)) {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) throws Exception {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        emp.setAddress(new Address(txtStreet.getText(), txtWard.getText(), txtDistrict.getText(), txtCity.getText()));
        ...
        if (validatePhoneAndEmail(emp)) {
            ...
            if (selectedRow != -1) {
                ...
                tableModel.setValueAt(emp.getAddress().getStreet(), selectedRow, 4);
                tableModel.setValueAt(emp.getAddress().getWard(), selectedRow, 5);
                tableModel.setValueAt(emp.getAddress().getDistrict(), selectedRow, 6);
                tableModel.setValueAt(emp.getAddress().getCity(), selectedRow, 7);
                tableModel.setValueAt(emp.getEmail(), selectedRow, 8);
                tableModel.setValueAt(emp.getPassword(), selectedRow, 9);
                tableModel.setValueAt(emp.getRole().getRoleName(), selectedRow, 10);
                tableModel.setValueAt(emp.isActive() ? "true" : "false", selectedRow, 11);
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) throws Exception {//GEN-FIRST:event_tableMouseClicked
        ...
        String street = table.getValueAt(selectedRow, 4).toString();
        String ward = table.getValueAt(selectedRow, 5).toString();
        String district = table.getValueAt(selectedRow, 6).toString();
        String city = table.getValueAt(selectedRow, 7).toString();
        String email = table.getValueAt(selectedRow, 8).toString();
        String pass = table.getValueAt(selectedRow, 9).toString();
        String role = table.getValueAt(selectedRow, 10).toString();
        String active = table.getValueAt(selectedRow, 11).toString();
