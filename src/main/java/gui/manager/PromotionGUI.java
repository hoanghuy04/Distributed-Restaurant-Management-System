...
public class PromotionGUI extends javax.swing.JPanel {
     ...
     */
    public PromotionGUI() throws Exception {
    ...
    private PromotionEntity convertData() throws Exception {
    ...
    private void cbbTypeActionPerformed(java.awt.event.ActionEvent evt) throws Exception {//GEN-FIRST:event_cbbTypeActionPerformed
        if (cbbType.getSelectedItem().toString().equals("ITEM")) {
...
//        JOptionPane.showMessageDialog(this,pros);
    ...
    private void cbbTypeMouseClicked(java.awt.event.MouseEvent evt) throws Exception {//GEN-FIRST:event_cbbTypeMouseClicked
        if (cbbType.getSelectedItem().toString().equals("ITEM")) {
            this.items = new ArrayList<>();
            for (String itemId : txtItem.getText().trim().split(",")) {
                if (!itemId.trim().isEmpty()) {
